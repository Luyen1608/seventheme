...
!function(n) {
   ...
   function u(t) {
       ...
       n(i).each(function() {
           ...
           if (i.hasClass("open") && t) {
               if (t && t.type == "click" && /input|textarea/i.test(t.target.tagName) && n.contains(i[0], t.target))
                   return i.trigger(t = n.Event("hide.bs.dropdown", f));
   ...
   t.prototype.toggle = function(t) {
       ...
       if (!f.is(".disabled, :disabled")) {
           ...
           !o) {
               ...
               i.trigger(t = n.Event("show.bs.dropdown", e)),
               t.isDefaultPrevented())
                   return f.trigger("focus").attr("aria-expanded", "true");
   ...
   t.prototype.keydown = function(t) {
       ...
       !o.is(".disabled, :disabled"))) {
           ...
           s = e.hasClass("open"),
           !s && t.which != 27 || s && t.which == 27) {
               t.which == 27 && e.find(i).trigger("focus");
               return
           }
           (h = " li:not(.disabled):visible a",
