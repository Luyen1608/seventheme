<div class="okui-dialog-window okui-dialog-window-float" style="width: 800px;">
                                            ...
                                            <div>
                                                <div class="index_fieldsWrapper__TU8xC">
                                                    <div class="index_field__ChY21"><span
                                                            ...
                                                            động</span><span
                                                            class="index_fieldValue__1BeeA"><?php echo $basic_info['thoi_gian_hoat_dong']?></span>
                                                    </div>
                                                    <div class="index_field__ChY21"><span
    ...
    <div class="okui-dialog-footer-box okui-dialog-footer-line">
        <div class="okui-dialog-btn-box layout-right"><a href="<?php echo  the_permalink();?>"><button type="button"
                class="okui-btn btn-sm btn-fill-tertiary dialog-btn"><span class="btn-content">Xem chi tiết</span></button></a></div>
    </div>
</div>