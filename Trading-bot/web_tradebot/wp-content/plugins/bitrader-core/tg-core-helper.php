...
/**
 * Plugin Name: Bitrader Core
 * Description: Bitrader elementor core plugin.
 * Plugin URI:  https://thetork.com/
 * Version:     1.0
 * Author:      TheTork
 ...
 *
 */
add_filter( 'the_content', 'bitrader_shortcode_extra_content_remove' );
/**
 ...
 */
function bitrader_shortcode_extra_content_remove( $content ) {
 ...
 *
 */
function bitrader_plugin_textdomain() {
    load_plugin_textdomain('genixcore', false, dirname(plugin_basename(__FILE__)) . '/languages');
}
add_action('plugins_loaded', 'bitrader_plugin_textdomain');
...
final class Genix_Core {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Bitrader Core', 'genixcore' ) . '</strong>',
