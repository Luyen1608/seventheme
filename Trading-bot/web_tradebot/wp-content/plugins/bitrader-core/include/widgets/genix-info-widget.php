<?php
	/**
	 * Bitrader Footer full Widget
	 *
	 *
	 * @author 		TheTork
	 * @category 	Widgets
	 * @package 	Bitrader/Widgets
	 * @version 	1.0.0
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'Bitrader_info_Widget');
	function Bitrader_info_Widget() {
		register_widget('Bitrader_info_Widget');
	}


	class Bitrader_info_Widget  extends WP_Widget{

		public function __construct(){
			parent::__construct('Bitrader_info_Widget',esc_html__('Bitrader Info','genixcore'),array(
				'description' => esc_html__('Bitrader Info Widget','genixcore'),
			));
		}
		...
		?>
			...
			<div class="cs-text_widget">
				...
				<div class="footer-logo cs-site_branding mb-4">
					<a href="<?php print home_url(); ?>"><img src="<?php print $image_box_image; ?>" alt="<?php echo esc_attr__('Bitrader','genixcore') ?>"></a>
				</div>
				<?php endif; ?>
