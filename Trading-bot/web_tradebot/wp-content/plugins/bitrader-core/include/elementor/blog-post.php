                                ...
                                <div class="blog__item blog__item--style2" data-aos="fade-right" data-aos-duration="1000">
                                    <div class="blog__item-inner blog__item-inner--style2 pt-30 px-30 pb-40">
                                        ...
                                        <div class="blog__content mt-30">
                                            <h5 class="style2">
                                                <a href="<?php the_permalink(); ?>"><?php echo wp_trim_words(get_the_title(), $settings['genix_blog_title_word'], ''); ?></a>
                                            </h5>
                                            ...
                                            ?>
                                                <p class="mb-15"><?php print wp_trim_words(get_the_excerpt(get_the_ID()), $genix_post_content_limit, ''); ?></p>
                                            <?php endif; ?>

                                            <a href="<?php the_permalink(); ?>" class="text-btn text-btn--style2"><?php echo esc_html__('Read more', 'genixcore') ?> <i class="fas fa-angle-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="blog__content">
                                                <?php if (!empty($categories[0]->name)) : ?>
                                                    <div class="blog__meta">
                                                        <a href="<?php print esc_url(get_category_link($categories[0]->term_id)); ?>" class="blog__meta-tag blog__meta-tag--style1"><?php echo esc_html($categories[0]->name); ?></a>
                                                    </div>
                                                <?php endif; ?>
                                                <h5 class="10">
                                                    <a href="<?php the_permalink(); ?>"><?php echo wp_trim_words(get_the_title(), $settings['genix_blog_title_word'], ''); ?></a>
                                                ...
                                                <div class="blog__writer">
                                                    ...
                                                    <div class="blog__writer-designation">
                                                        <h6 class="mb-0"><?php print get_the_author(); ?></h6>
