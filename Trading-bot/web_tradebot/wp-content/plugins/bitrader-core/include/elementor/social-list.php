...
?>
            ...
            <ul class="social list-wrap">
                <?php foreach ($settings['item_lists'] as $item) : ?>
                    <li class="social__item">
                        <a href="<?php echo esc_url($item['tg_url']); ?>" class="social__link social__link--style22"><?php genix_render_icon($item, 'tg_icon', 'tg_selected_icon'); ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        ...
        <?php else : ?>
            <ul class="social list-wrap">
                <?php foreach ($settings['item_lists'] as $item) : ?>
                    <li class="social__item">
                        <a href="<?php echo esc_url($item['tg_url']); ?>" class="social__link social__link--style2"><?php genix_render_icon($item, 'tg_icon', 'tg_selected_icon'); ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        <?php endif; ?>
