...
// Bg color
$footer_bg_color = get_theme_mod('bitrader_footer_bg_color');


// BG Color
$bg_color = !empty($bitrader_footer_bg_color) ? $bitrader_footer_bg_color : $footer_bg_color;
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p><?php print bitrader_copyright_text(); ?></p>
                        </div>
                    </div>
                </div>
            </div>
